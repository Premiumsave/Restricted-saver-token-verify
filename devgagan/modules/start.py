...
async def terms(client, message):
    ...
    buttons = InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("💬 Contact Now", url="https://t.me/Kingofmarket03")],
        ]
    )
...
async def plan(client, message):
    plan_text = (
        "💰 **Premium Price**: Starting from  499rs for 1 months 😇accepted via **Upi** to purchase contact @Kingofmarket03 (terms and conditions apply).\n"
