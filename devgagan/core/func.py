   ...
   if update_channel:
      try:
         ...
         if user.status == "kicked":
            await message.reply_text("You are Banned. Contact -- @Traderpersonaladvice2314")
            return 1
         ...
         await message.reply_text("Something Went Wrong. Contact us @Traderpersonaladvice2314...")
         return 1
